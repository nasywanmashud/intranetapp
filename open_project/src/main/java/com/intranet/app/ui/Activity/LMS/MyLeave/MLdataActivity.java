...
public class MLdataActivity extends MainFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.main_content, MLdataFragment.newInstance(bundle)).commit();
