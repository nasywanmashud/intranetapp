...
public class ULdataActivity extends MainFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.main_content, ULdataFragment.newInstance(bundle)).commit();
