...
public class TimesheetSearchActivity extends MainFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.main_content, TimesheetSearchFragment.newInstance(bundle)).commit();
