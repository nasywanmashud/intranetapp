...
public class LMSdataActivity extends MainFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.main_content, LMSdataFragment.newInstance(bundle)).commit();
