package com.intranet.app.ui.Activity.TabTimesheet;
...
public class TabTimesheet extends MainFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_timesheet);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarTimesheet);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in = new Intent(TabTimesheet.this,Main3Activity.class);
                startActivity(in);
                finish();
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                ...
                case 0:
                    TimesheetApprovalFragment timesheetApprovalFragment = new TimesheetApprovalFragment();
                    return timesheetApprovalFragment;
