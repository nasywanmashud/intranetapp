...
public class TimesheetApprovalFragment$$ViewBinder<T extends com.intranet.app.ui.Activity.TimesheetApproval.TimesheetApprovalFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131296336, "field 'btnsearch1'");
    target.btnsearch1 = finder.castView(view, 2131296336, "field 'btnsearch1'");
    ...
    view = finder.findRequiredView(source, 2131296525, "field 'listView'");
    target.listView = finder.castView(view, 2131296525, "field 'listView'");
